...
export class ProductsService {
 private baseUrl: string = '';
  ...
  constructor(private _GlobalService: GlobalService, private _HttpClient: HttpClient) {  this.baseUrl = this._GlobalService.baseUrl;
    this.baseUrl = this._GlobalService.baseUrl;
    this.productsRoute = this._GlobalService.productsRoute;
    this.productImages = _GlobalService.productsImage;
